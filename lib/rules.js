...
export const ORG_WORDS = ['人民法院', '人民法庭', '铁路运输法院', '互联网法院', '知识产权法院', '金融法院', '海事法院', '军事法院', '人民检察院', '人大常委会', '纪律检查委员会', '监察委员会', '市场监督管理局', '仲裁委员会', '仲裁院', '人民政府', '律师事务所', '公安厅', '公安分局', '公安局', '检察院', '派出所', '分局', '仲裁委', '司法局', '司法所', '税务局', '管理局', '管理委员会', '管委会', '人大', '政协', '办事处', '街道办事处', '居民委员会', '村民委员会', '村委会', '居委会'];
