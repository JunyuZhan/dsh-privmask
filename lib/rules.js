...
export const ORG_WORDS = ['人民法院', '人民检察院', '人大常委会', '纪律检查委员会', '监察委员会', '市场监督管理局', '仲裁委员会', '人民政府', '律师事务所', '公安厅', '公安分局', '公安局', '检察院', '派出所', '仲裁委', '司法局', '司法所', '税务局', '人大', '政协', '办事处', '街道办事处', '居民委员会', '村民委员会', '村委会', '居委会'];
export const ORG_LIMIT = '中级高级基层第一第二铁路海事知识产权互联网金融监察纪律检查人民审判全国中央';
export const PROVINCES = '京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼';
export const ADDR_CTX = ['户籍地址', '住所地', '户籍地', '联系地址', '注册地址', '送达地址', '现住址', '现住', '居住地', '住址', '地址'];
