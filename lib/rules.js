...
export const NAME_CTX = ['法定代表人', '委托代理人', '申请执行人', '被申请人', '被执行人', '申请人', '审判长', '审判员', '人民陪审员', '书记员', '检察员', '检察官', '联系人', '收货人', '代理人', '辩护人', '监护人', '案外人', '异议人', '利害关系人', '当事人', '原告', '被告', '第三人', '债务人', '债权人', '担保人', '出借人', '借款人', '出租人', '承租人', '户主', '董事长', '总经理', '监事', '董事', '股东', '负责人', '姓名', '名字', '签字', '签名', '签章', '经理', '委托人', '被委托人', '委托方', '受托方', '证人', '鉴定人', '经办人', '收件人', '收款人', '付款人', '合伙人', '投资人', '实际控制人', '控股股东', '一致行动人', '上诉人', '被上诉人', '原审原告', '原审被告', '再审申请人', '欠款人', '欠款方', '欠条', '借条', '被继承人', '继承人', '遗赠人', '受遗赠人', '转让方', '受让方', '出让方', '居间人', '寄件人', '投保人', '被保险人', '受益人', '买方', '卖方', '甲方', '乙方', '丙方', '发包人', '承包人', '托运人', '承运人', '出租方', '承租方', '又名', '别名', '曾用名', '查询', '检索', '查找', '搜索', '了解', '介绍'];
...
export const NAME_TAILS = ['请求', '要求', '表示', '提出', '指出', '强调', '主张', '委托', '担任', '负责', '涉嫌', '离婚', '起诉', '上诉', '反诉', '签订', '签署', '结婚', '借款', '拖欠', '抚养', '继承', '经营', '死亡', '失踪', '诉称', '诉请', '民间借贷纠纷一案', '借款纠纷一案', '借贷纠纷一案', '合同纠纷一案', '金融借款合同纠纷', '金融借款合同纠纷一案', '物业服务合同纠纷', '物业服务合同纠纷一案', '服务合同纠纷', '服务合同纠纷一案', '买卖合同纠纷', '租赁合同纠纷', '劳动合同纠纷', '劳动争议纠纷', '交通事故责任纠纷', '机动车交通事故责任纠纷', '侵权责任纠纷', '赡养纠纷', '探望权纠纷', '相邻关系纠纷', '散伙清算纠纷', '股权转让协议', '居间合同纠纷', '借款纠纷', '借贷纠纷', '合同纠纷', '物业服务合同', '服务合同', '纠纷一案', '一案', '民间借贷', '劳动争议', '赡养', '探望权', '相邻关系', '散伙清算', '律师', '还款', '清偿', '支付', '偿还', '拖欠货款', '货款', '欠款', '借款人民币', '人民币', '买卖合同', '租赁合同', '劳动合同', '交通事故', '侵权责任', '不当得利', '无因管理', '判决', '裁定', '调解', '立案', '审理', '宣判', '上诉状', '答辩状', '起诉状', '代理词', '证据', '举证', '质证', '保全', '执行', '仲裁', '公证', '担保', '保证', '抵押', '质押', '利息', '违约金', '诉讼费', '案件受理费', '公告费', '送达',
  ...
  '尚欠', '欠付', '应于', '应支付', '应偿还', '应赔偿', '应承担', '经传票传唤', '下落不明',
  // 答辩表述（「王五辩称」「王五答辩称」）
  '辩称', '答辩称',
...
export const ORG_KEYS = ['有限责任公司', '股份有限公司', '集团有限公司', '有限公司', '集团', '控股', '事务所', '研究所', '研究院', '合作社', '出版社', '银行', '医院', '学校', '学院', '大学', '公司', '工厂', '饭店', '酒店', '购物中心', '商场', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行'];
/** 强标识后缀：公司名前缀无需地区/行业词佐证（避免漏掉「阿里巴巴集团」「华为技术有限公司」这类常见公司） */
export const ORG_STRONG = new Set(['集团', '控股', '事务所', '研究所', '研究院', '出版社', '银行', '医院', '学校', '学院', '大学', '工厂', '饭店', '酒店', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行']);
/** 常见生活名词类机构后缀：泛化语境（在学校/那家酒店/爸爸去工厂）中需区分泛指与机构名 */
export const ORG_COMMON_STRONG = ['学校', '医院', '银行', '酒店', '饭店', '工厂', '大学', '学院', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行'];
...
export const ORG_PREFIX_VERBS = ['查询', '委托', '联系', '起诉', '控告', '报案', '走访', '前往', '来到', '请求', '要求', '提交', '发送', '交付', '出租给', '交付给', '转让给', '出售给', '寄送', '递交', '办理', '协助'];
...
export const ORG_WORDS = ['人民法院', '人民检察院', '人大常委会', '纪律检查委员会', '监察委员会', '市场监督管理局', '仲裁委员会', '仲裁院', '人民政府', '律师事务所', '公安厅', '公安分局', '公安局', '检察院', '派出所', '仲裁委', '司法局', '司法所', '税务局', '人大', '政协', '办事处', '街道办事处', '居民委员会', '村民委员会', '村委会', '居委会'];
export const ORG_LIMIT = '中级高级基层第一第二铁路海事知识产权互联网金融监察纪律检查人民审判全国中央';
export const PROVINCES = '京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼';
export const ADDR_CTX = ['户籍所在地', '户籍地址', '经常居住地', '实际居住地', '住所地', '户籍地', '联系地址', '注册地址', '送达地址', '现住址', '现住', '居住地', '住址', '地址'];
      ...
      while ((m = re.exec(out)) !== null) {
        ...
        if (mm !== null) {
          ...
          if (/^(我|你|他|她|它|咱)[们]?$/.test(local)
            || /^(本|邻|各|全|回|进|出|去|在|到|住|走|来|某|该|这|那|隔壁)$/.test(local)
      ...
      while ((m = ctxRe.exec(out)) !== null) {
        ...
        while (name !== null) {
          ...
          if (sep !== null) {
            ...
            // 亲属关系链（「被告张三之父王大明」）：之父/之母/之妻/之夫/之子/之女 后的姓名继续识别
            const kin = /^(之父|之母|之妻|之夫|之子|之女)\s*/.exec(after);
            if (kin === null) break;
    ...
    cat: 'company', fn: (text, engine, rctx) => {
      ...
      while ((m = keyRe.exec(out)) !== null) {
        ...
        for (const ch of PRONOUN) {
          ...
          trimmed = trimmed.replace(new RegExp('^' + ch), '');
          start += before - trimmed.length;
        }
