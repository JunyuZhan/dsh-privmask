...
export const ORG_KEYS = ['有限责任公司', '股份有限公司', '集团有限公司', '有限公司', '集团', '控股', '事务所', '研究所', '研究院', '合作社', '出版社', '银行', '医院', '学校', '学院', '大学', '公司', '工厂', '饭店', '酒店', '购物中心', '商场', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行', '协会', '基金会', '联合会', '商会', '学会'];
/** 强标识后缀：公司名前缀无需地区/行业词佐证（避免漏掉「阿里巴巴集团」「华为技术有限公司」这类常见公司） */
export const ORG_STRONG = new Set(['集团', '控股', '事务所', '研究所', '研究院', '出版社', '银行', '医院', '学校', '学院', '大学', '工厂', '饭店', '酒店', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行', '协会', '基金会', '联合会', '商会', '学会']);
/** 常见生活名词类机构后缀：泛化语境（在学校/那家酒店/爸爸去工厂）中需区分泛指与机构名 */
export const ORG_COMMON_STRONG = ['学校', '医院', '银行', '酒店', '饭店', '工厂', '大学', '学院', '中学', '小学', '幼儿园', '门诊部', '诊所', '卫生院', '卫生室', '分行', '支行', '协会', '基金会', '联合会', '商会', '学会'];
