...
export const CN_RULES = [
  ...
  // 带「统一社会信用代码/信用代码」上下文的 18 位编码始终脱敏：作者已明确标注，
  // 不依赖校验位（与身份证上下文修复同一逻辑）；裸「编号/订单号」不作触发词
  { cat: 'uscc', re: /(统一社会信用代码|信用代码)\s*[:：]?\s*([0-9A-HJ-NPQRTUWXY]{18})(?![0-9A-Za-z])/g, secretGroup: 2 },
