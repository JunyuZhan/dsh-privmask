window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function PrivmaskCard(props) {
			...
			const switchRow = (key, label) => (0, react_jsx_runtime.jsxs)("div", {
				style: line,
				children: [(0, react_jsx_runtime.jsx)("span", { children: label }), (0, react_jsx_runtime.jsx)("button", {
					type: "button",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					writable && cfg !== null ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							style: line,
							children: [(0, react_jsx_runtime.jsx)("span", { children: "全面脱敏（姓名/公司/机关）" }), (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: !writable || saving !== null,
								style: {
									...toggleBase,
						...
						style: body,
						children: "运行时开关不可用（settings 未挂载时保持配置文件模式）。"
					}),
					(0, react_jsx_runtime.jsx)("div", {
						style: body,
