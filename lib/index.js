...
export function apply(ctx, config = {}) {
  ...
  diag('启动 cfg: restoreInbound=' + cfg.restoreInbound + ' dropSessionId=' + cfg.dropSessionId + ' persistMapping=' + cfg.persistMapping + ' nonTextPolicy=' + cfg.nonTextPolicy + ' preflightBase64=' + cfg.preflightBase64 + ' enabled=' + cfg.enabled);
