...
const SURNAMES = '王李张刘陈杨黄赵吴周徐孙马朱胡郭何高林罗郑梁谢宋唐许韩冯邓曹彭曾肖田董袁潘于蒋蔡余杜叶程苏魏吕丁任沈姚卢姜崔钟谭陆汪范金石廖贾夏韦付方白邹孟熊秦邱江尹薛闫段雷侯龙史陶黎贺顾毛郝龚邵万钱严覃武戴莫孔向汤詹傅萧欧区湛戚左卓席麦米柳苗俞谷屈庞康阎涂桂翁谈邢易童路舒解樊鲁乐祁霍纪单尚穆滕娄牟卞瞿章乔文关管应古蓝明邬赖安温洪齐尤项池甄焦桑芦栗';
...
const NAME_PARTICLES = '的了着过呢吧嘛啊呀在把被与和及或为从对向于诉';
/** 姓名后常见动词/助词短语：从候选名尾部裁掉，避免把「认为/行为」等词吞进占位符（按长度降序匹配） */
const NAME_TAILS = ['请求', '要求', '表示', '提出', '指出', '强调', '主张', '委托', '担任', '负责', '涉嫌', '离婚', '起诉', '上诉', '反诉', '签订', '签署', '结婚', '借款', '拖欠', '抚养', '继承', '经营', '死亡', '失踪'];
