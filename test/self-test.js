...
const T = {
  ...
  procuratorate: cn(0x5317, 0x4eac, 0x5e02, 0x4eba, 0x6c11, 0x68c0, 0x5bdf, 0x9662),
...
const options = {
  ...
  messages: [
    { role: 'user', content: [
      ...
      { type: 'text', text: T.court + '，' + T.procuratorate + '，' + T.company },
...
async function run() {
  ...
  const checks = [
    ...
    ['法院默认保留', all.includes(T.court)],
    ['检察机关脱敏', !all.includes(T.procuratorate) && all.includes('[REDACTED_ORG_')],
